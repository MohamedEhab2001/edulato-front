...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex">
        ...
        <div className="w-full max-w-md">
          ...
          <AnimatedSection delay={100}>
            <form className="space-y-5">
              <div>
                <label className="block text-secondary font-medium mb-2">{t('name')}</label>
                <input
                  type="text"
                  required
              ...
              <div>
                <label className="block text-secondary font-medium mb-2">{t('confirmPassword')}</label>
                <div className="relative">
                  <input
              ...
              <div className="flex items-start gap-2">
                <input type="checkbox" required className="w-4 h-4 mt-1 rounded border-gray-300 text-primary focus:ring-primary" />
      ...
      <div className="hidden lg:flex lg:flex-1 bg-gradient-to-br from-secondary via-secondary to-primary items-center justify-center p-8 relative overflow-hidden">
        <ParticlesMini />
        <div className="relative max-w-md text-center text-white">
          <div className="text-5xl mb-6">🎯</div>
          <h2 className="text-3xl font-bold mb-4">ابدأ مجاناً اليوم</h2>
          <p className="text-white/80 text-lg">لا حاجة لبطاقة ائتمان. ابدأ في إنشاء دوراتك في دقائق.</p>
          <div className="mt-8 space-y-4">
            <div className="flex items-center gap-3 justify-center">
              ...
              <span className="text-white/90">إنشاء حساب في ثوانٍ</span>
            </div>
            <div className="flex items-center gap-3 justify-center">
              <div className="w-6 h-6 bg-white/20 rounded-full flex items-center justify-center">
                <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <span className="text-white/90">لا حاجة لبطاقة ائتمان</span>
            </div>
            <div className="flex items-center gap-3 justify-center">
              <div className="w-6 h-6 bg-white/20 rounded-full flex items-center justify-center">
                <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <span className="text-white/90">دعم مجاني على مدار الساعة</span>
            </div>
          </div>
        </div>
      </div>
